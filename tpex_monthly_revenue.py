...
def monthly_report(year, month):
    ...
    url = 'https://mops.twse.com.tw/server-java/FileDownLoad?step=9&functionName=show_file&filePath=%2Fhome%2Fhtml%2Fnas%2Ft21%2Fotc%2F&fileName=t21sc03_'+str(year_r)+'_'+str(month)+'.csv'
